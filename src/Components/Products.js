        ...
        return (
          <>
            <div className="buttons d-flex justify-content-center mb-5 pb-5">
              ...
              <button className="btn btn-outline-dark me-2" onClick={() => filterProduct("dairy")}>
                Dairy
              </button>
              <button
                className="btn btn-outline-dark me-2" onClick={() => filterProduct("fruit")}>
                Fruit
              </button>
              <button
                className="btn btn-outline-dark me-2" onClick={() => filterProduct("vegetable")}>
                Vegetable
              </button>
            </div>
            {filter.map((product) => {
                  ...
                  <div className="col-md-3 mb-4">
                    <div className="card h-100 text-center p-4" key={product.id}>
                      ...
                      <div className="card-body">
                        ...
                        <NavLink to={`/products/${product.id}`} className="btn btn-dark ms-2 px-3 py-2 my-4">
                          Go to Cart
                        </NavLink>
